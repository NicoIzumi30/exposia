            ...
            <div class="overflow-x-auto">
                <table class="w-full table-auto">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-200" data-testimonial-id="{{ $testimonial->id }}">
                            ...
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900 line-clamp-3 max-w-md">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    <button onclick="editTestimonial('{{ $testimonial->id }}')" 
                                            class="text-gray-600 hover:text-gray-900 transition-colors duration-200 p-2 rounded-lg hover:bg-gray-100"
                                            title="Edit">
    ...
    <div class="lg:col-span-1 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-slide-up">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Statistik Testimoni</h3>
                </div>
            </div>
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <span class="text-gray-600">Total Testimoni</span>
                    <span class="text-2xl font-bold text-gray-800">{{ $testimonialStats['total'] }}</span>
                </div>
                @if($testimonialStats['total'] > 0)
                <div class="flex items-center justify-between">
                    <span class="text-gray-600">Bulan Ini</span>
                    <span class="text-lg font-semibold text-gray-700">{{ $testimonialStats['this_month'] }}</span>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-xl border border-gray-200 p-6 animate-slide-up">
            <div class="flex items-center mb-4">
                ...
                <h4 class="font-semibold text-gray-800">Tips Testimoni</h4>
            </div>
...
<div id="testimonialModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" aria-hidden="true" onclick="closeTestimonialModal()"></div>
        ...
        <div class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button onclick="closeTestimonialModal()" class="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200">
            ...
            <form id="testimonialForm" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="testimonialName" name="testimonial_name" required
                           class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200"
                ...
                <div>
                    <label class="flex items-center text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-quote-right mr-2 text-gray-600"></i>
