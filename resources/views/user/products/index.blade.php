    ...
    <div class="flex items-center space-x-3 mt-4 sm:mt-0">
        ...
        <div class="relative hidden sm:block">
            <input type="text" id="searchProducts" placeholder="Cari produk..." 
                   class="w-64 pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
...
<div class="sm:hidden mb-6">
    <div class="relative">
        <input type="text" id="searchProductsMobile" placeholder="Cari produk..." 
               class="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200">
        <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400"></i>
    </div>
</div>
            ...
            <form id="productForm" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="productDescription" name="product_description" rows="4" required
                                  class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:outline-none transition-all duration-200"
                                  placeholder="Jelaskan detail produk, manfaat, dan keunggulannya"></textarea>
                        <div class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="productPrice" name="product_price" required min="0" step="1000"
                                   class="w-full pl-12 pr-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:outline-none transition-all duration-200"
                                   placeholder="0">
                        </div>
                        <div class="error-message hidden mt-1 text-sm text-red-600 dark:text-red-400"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="productWaLink" name="product_wa_link"
                               class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:border-blue-500 dark:focus:border-blue-400 focus:ring-2 focus:ring-blue-500/20 dark:focus:ring-blue-400/20 focus:outline-none transition-all duration-200"
...
document.getElementById('productForm').addEventListener('submit', function(e) {
    ...
    const url = isEditMode 
        ? buildUrl('update', currentProductId)
        : buildUrl('store');
...
function handleImageUpload(file) {
    ...
    reader.onload = (e) => {
        ...
        setTimeout(() => {
            ...
            showToast('Foto siap untuk diupload!', 'success');
        }, 1000);
    };
...
function bulkAction(action) {
    ...
    switch(action) {
        case 'delete':
            confirmMessage = `Apakah Anda yakin ingin menghapus ${productIds.length} produk yang dipilih?`;
            break;
        case 'pin':
            confirmMessage = `Pin ${productIds.length} produk yang dipilih?`;
            break;
        case 'unpin':
            confirmMessage = `Unpin ${productIds.length} produk yang dipilih?`;
            break;
    }
    ...
    if (confirm(confirmMessage)) {
        ...
        .then(data => {
            if (data.success) {
                ...
                showToast(data.message || 'Gagal melakukan aksi bulk', 'error');
            }
        })
        .catch(error => {
            console.error('Error:', error);
            showToast('Terjadi kesalahan saat melakukan aksi bulk', 'error');
        });
    }
}
