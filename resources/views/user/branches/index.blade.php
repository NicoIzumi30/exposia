...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="space-y-4" id="branches-container">
            ...
            <div class="branch-card bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-lg transition-all duration-200 animate-slide-up" data-branch-id="{{ $branch->id }}">
                <div class="flex flex-col md:flex-row md:items-start md:justify-between">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="space-y-2 text-sm">
                                    <div class="flex items-start space-x-2">
                                        ...
                                        <span class="text-gray-600">{{ $branch->branch_address }}</span>
                                    </div>
                                    <div class="flex items-center space-x-2">
                                        <i class="fas fa-clock text-gray-400 flex-shrink-0"></i>
                                        <span class="text-gray-600">{{ $branch->branch_operational_hours }}</span>
                                    </div>
                                    @if($branch->branch_phone)
                                    <div class="flex items-center space-x-2">
                                        <i class="fas fa-phone text-gray-400 flex-shrink-0"></i>
                                        <span class="text-gray-600">{{ $branch->branch_phone }}</span>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="{{ $branch->branch_google_maps_link }}" target="_blank" class="text-gray-800 hover:text-gray-600 transition-colors duration-200">
                    ...
                    <div class="flex items-center space-x-2 mt-4 md:mt-0 ml-16 md:ml-4">
                        <button onclick="editBranch('{{ $branch->id }}')" class="p-2 text-gray-700 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button onclick="deleteBranch('{{ $branch->id }}', '{{ $branch->branch_name }}')" class="p-2 text-red-600 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center animate-slide-up">
            ...
            <h3 class="text-lg font-semibold text-gray-900 mb-2">Belum Ada Cabang</h3>
            <p class="text-gray-600 mb-6 max-w-md mx-auto">
                Tambahkan cabang usaha Anda untuk mempermudah pelanggan menemukan lokasi bisnis.
            </p>
            <button onclick="openBranchModal()" class="bg-gray-800 hover:bg-gray-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
    ...
    <div class="lg:col-span-1 space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 animate-slide-up">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Statistik Cabang</h3>
                </div>
            </div>
            <div class="space-y-4">
                <div class="flex items-center justify-between">
                    <span class="text-gray-600">Total Cabang</span>
                    <span class="text-2xl font-bold text-gray-800">{{ $branches->count() }}</span>
                </div>
                @if($branches->count() > 0)
                <div class="flex items-center justify-between">
                    <span class="text-gray-600">Dengan Kontak WhatsApp</span>
                    <span class="text-lg font-semibold text-green-600">{{ $branches->whereNotNull('branch_phone')->count() }}</span>
                </div>
                <div class="flex items-center justify-between">
                    <span class="text-gray-600">Dengan Google Maps</span>
                    <span class="text-lg font-semibold text-gray-700">{{ $branches->whereNotNull('branch_google_maps_link')->count() }}</span>
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-gray-50 rounded-xl border border-gray-200 p-6 animate-slide-up">
            <div class="flex items-center mb-4">
                ...
                <h4 class="font-semibold text-gray-800">Tips Cabang</h4>
            </div>
...
<div id="branchModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75" aria-hidden="true" onclick="closeBranchModal()"></div>
        ...
        <div class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button onclick="closeBranchModal()" class="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 transition-colors duration-200">
            ...
            <form id="branchForm" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="branchName" name="branch_name" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200" placeholder="Contoh: Cabang Malioboro, Cabang Yogya">
                ...
                <div>
                    ...
                    <textarea id="branchAddress" name="branch_address" rows="3" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200" placeholder="Masukkan alamat lengkap cabang"></textarea>
                    <div class="error-message hidden mt-1 text-sm text-red-600"></div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="branchHours" name="branch_operational_hours" required class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200" placeholder="Senin-Sabtu 08:00-17:00">
                        <div class="error-message hidden mt-1 text-sm text-red-600"></div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="branchPhone" name="branch_phone" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200" placeholder="08123456789">
                        <div class="error-message hidden mt-1 text-sm text-red-600"></div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="url" id="branchMapsLink" name="branch_google_maps_link" class="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500 focus:border-gray-800 focus:ring-2 focus:ring-gray-800/20 focus:outline-none transition-all duration-200" placeholder="https://maps.google.com/...">
                    <div class="error-message hidden mt-1 text-sm text-red-600"></div>
                </div>
                ...
                <div class="flex flex-col sm:flex-row gap-3 pt-6">
                    ...
                    <button type="button" onclick="closeBranchModal()" class="flex-1 sm:flex-none bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-3 px-6 rounded-xl transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                        Batal
                    </button>
                </div>
            </form>
