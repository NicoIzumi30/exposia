    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden animate-slide-up">
                ...
                <!-- Card Content -->
                <div class="p-6">
                    <form action="{{ route('user.account.update-profile') }}" method="POST" class="space-y-5">
                        @csrf
                        @method('PUT')
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden animate-slide-up">
                ...
                <!-- Card Content -->
                <div class="p-6">
                    <form action="{{ route('user.account.update-password') }}" method="POST" class="space-y-5">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <p class="text-sm {{ auth()->user()->email_verified_at ? 'text-green-700 dark:text-green-400' : 'text-yellow-700 dark:text-yellow-400' }} mt-1">
                                    ...
                                    @else
                                    Email belum terverifikasi. Silakan periksa inbox Anda.
                                    @endif
                                </p>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        async function handleFormSubmit(form, options = {}) {
            ...
            try {
                ...
                // Hanya set loading false JIKA tidak ada redirect
                if (!options.onSuccess || !options.onSuccess.toString().includes('window.location.href')) {
        ...
        function initVerificationForm() {
            ...
            if (form) {
                form.addEventListener('submit', (e) => {
                    ...
                    handleFormSubmit(form, {
                        onSuccess: (data) => {
                            showToast('Email verifikasi berhasil dikirim! Silakan periksa inbox Anda.', 'success');
                        }
                    });
                });
            }
