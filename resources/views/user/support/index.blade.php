    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-slide-up">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900">Video Tutorial</h2>
                            <p class="text-sm text-gray-600">Pelajari cara menggunakan platform secara lengkap</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    ...
                    <!-- Video Info -->
                    <div class="space-y-3">
                        <h3 class="text-lg font-semibold text-gray-900">Tutorial Lengkap Penggunaan Platform</h3>
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-slide-up">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold text-gray-900">Tim Support</h2>
                            <p class="text-sm text-gray-600">Bantuan langsung</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="text-center">
                            ...
                            <h3 class="font-semibold text-gray-900 mb-2">Customer Support</h3>
                        ...
                        <!-- Contact Button -->
                        <a href="{{ $whatsapp_cs_link ?? 'https://wa.me/62859126462972?text=Halo,%20saya%20butuh%20bantuan%20terkait%20website%20UMKM%20saya.' }}" target="_blank" class="w-full inline-flex items-center justify-center px-4 py-3 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg shadow-sm hover:shadow focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transform hover:scale-[1.02] transition-all duration-200">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-slide-up">
                ...
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Akses cepat</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <a href="{{ route('user.business.index') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                            <i class="fas fa-building text-gray-600 mr-3"></i>
                            <span class="text-gray-700 text-sm">Data Usaha</span>
                        </a>
                        <a href="{{ route('user.products.index') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                            <i class="fas fa-box text-gray-600 mr-3"></i>
                            <span class="text-gray-700 text-sm">Produk</span>
                        </a>
                        <a href="{{ route('user.templates.index') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                            <i class="fas fa-paint-brush text-gray-600 mr-3"></i>
                            <span class="text-gray-700 text-sm">Template</span>
                        </a>
                        <a href="{{ route('user.publish.index') }}" class="flex items-center p-3 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                            <i class="fas fa-globe text-gray-600 mr-3"></i>
                            <span class="text-gray-700 text-sm">Publikasi</span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden animate-slide-up">
        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">Pertanyaan Umum</h2>
                    <p class="text-sm text-gray-600">Jawaban untuk pertanyaan yang sering diajukan</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-1">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara mempublikasikan website saya?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
                ...
                <!-- FAQ Item 2 -->
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-2">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara mengubah template website?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
                ...
                <!-- FAQ Item 3 -->
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-3">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara menggunakan AI Content Generator?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
                ...
                <!-- FAQ Item 4 -->
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-4">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara melihat statistik pengunjung website?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
                ...
                <!-- FAQ Item 5 -->
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-5">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara menambahkan produk baru?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
                ...
                <!-- FAQ Item 6 -->
                <div class="border border-gray-200 rounded-lg overflow-hidden">
                    <button class="faq-toggle w-full flex items-center justify-between p-4 text-left focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-inset hover:bg-gray-50 transition-colors duration-200" data-target="faq-6">
                        <span class="font-medium text-gray-900 text-sm">Bagaimana cara backup data website saya?</span>
                        <i class="fas fa-chevron-down text-gray-400 transition-transform duration-200 flex-shrink-0 ml-2"></i>
                    </button>
