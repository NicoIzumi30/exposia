    ...
    <nav class="flex-1 mt-4 px-4 space-y-1 overflow-y-auto scrollbar-hide">
        ...
        <a href="{{ route('admin.reports.index') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.reports.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            ...
            <span class="ml-auto inline-block px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400">5</span>
        </a>

        <!-- Statistics & Analytics -->
        <a href="{{ route('admin.statistics.index') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.statistics.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            <i class="fas fa-chart-bar mr-3 {{ request()->routeIs('admin.statistics.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
        ...
        <a href="{{ route('admin.settings.platform') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.settings.platform') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            <i class="fas fa-cog mr-3 {{ request()->routeIs('admin.settings.platform') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
            <span>Setting Platform</span>
        </a>

        <!-- Admin Management -->
        <a href="{{ route('admin.admins.index') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.admins.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            <i class="fas fa-user-shield mr-3 {{ request()->routeIs('admin.admins.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
            <span>Manajemen Admin</span>
        </a>

        <!-- Activity Logs -->
        <a href="{{ route('admin.activity-logs.index') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.activity-logs.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            <i class="fas fa-history mr-3 {{ request()->routeIs('admin.activity-logs.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
            <span>Log Aktivitas</span>
        </a>

        <!-- Help -->
        <a href="{{ route('admin.help.index') }}" 
           class="nav-item group flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 {{ request()->routeIs('admin.help.*') ? 'bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 border-r-2 border-indigo-500' : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white' }}">
            <i class="fas fa-question-circle mr-3 {{ request()->routeIs('admin.help.*') ? 'text-indigo-500' : 'text-gray-400 group-hover:text-gray-500' }}"></i>
            <span>Bantuan</span>
        </a>
    </nav>
    ...
    <div class="p-4 border-t border-gray-200 dark:border-gray-700 space-y-3">
        ...
        <div class="px-4 py-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
            <div class="flex items-center justify-between mb-2">
                <span class="text-sm font-medium text-gray-900 dark:text-white">Status Sistem</span>
                <span class="inline-flex h-2 w-2 rounded-full bg-green-400 animate-pulse-soft"></span>
            </div>
            <p class="text-xs text-gray-500 dark:text-gray-400">
                Server: Aktif • DB: Optimal
            </p>
        </div>
