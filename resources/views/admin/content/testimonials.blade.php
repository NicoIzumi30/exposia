                ...
                <tr>
                    <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center">
                            <i class="fas fa-quote-right text-4xl mb-4 text-gray-300"></i>
                            <p class="text-lg">Tidak ada testimonial ditemukan</p>
                            @if($search)
                            <p class="text-sm mt-1">Coba ubah kata kunci pencarian</p>
                            <a href="{{ route('admin.content.testimonials', ['business_id' => request('business_id')]) }}" class="mt-3 text-gray-600 hover:underline">
