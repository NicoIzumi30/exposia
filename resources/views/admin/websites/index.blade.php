        ...
        <div class="relative inline-block">
            ...
            <div id="filter-dropdown" 
                ...
                <a href="{{ route('admin.websites.index', ['status' => 'published', 'search' => $search]) }}" 
                   class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 {{ $status == 'published' ? 'bg-gray-100 font-medium' : '' }}">
                ...
                <a href="{{ route('admin.websites.index', ['status' => 'draft', 'search' => $search]) }}" 
                   class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 {{ $status == 'draft' ? 'bg-gray-100 font-medium' : '' }}">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-10 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <a href="{{ route('admin.websites.index') }}" class="mt-3 text-gray-600 hover:underline">
