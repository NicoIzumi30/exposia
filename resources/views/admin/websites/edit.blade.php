        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       required 
                       class="w-full px-4 py-2 border-gray-300 focus:ring-gray-500 focus:border-gray-500 rounded-md shadow-sm bg-white text-gray-900 @error('business_name') border-red-500 @enderror" 
            ...
            <div>
                ...
                <input type="text" 
                       ...
                       class="w-full px-4 py-2 border-gray-300 focus:ring-gray-500 focus:border-gray-500 rounded-md shadow-sm bg-white text-gray-900 @error('short_description') border-red-500 @enderror" 
            ...
            <!-- Main Address Field -->
            <div>
                <label for="main_address" class="block text-sm font-medium text-gray-700 mb-1">
                    Alamat Utama
                </label>
                <input type="text" 
                       name="main_address" 
                       ...
                       class="w-full px-4 py-2 border-gray-300 focus:ring-gray-500 focus:border-gray-500 rounded-md shadow-sm bg-white text-gray-900 @error('main_address') border-red-500 @enderror" 
            ...
            <div>
                <label for="main_operational_hours" class="block text-sm font-medium text-gray-700 mb-1">
                    Jam Operasional
                </label>
                <input type="text" 
                       ...
                       class="w-full px-4 py-2 border-gray-300 focus:ring-gray-500 focus:border-gray-500 rounded-md shadow-sm bg-white text-gray-900 @error('main_operational_hours') border-red-500 @enderror" 
        ...
        <div class="mt-6">
            <div class="bg-gray-50 rounded-lg p-4">
                ...
                <div class="flex items-center">
                    <span class="mr-3 text-sm text-gray-700">Status saat ini:</span>
