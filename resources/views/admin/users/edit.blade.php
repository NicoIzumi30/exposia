            ...
            <div>
                ...
                <div class="flex flex-col space-y-2">
                    <div class="flex items-center">
                        <span class="mr-3 text-sm text-gray-700">Status:</span>
                    ...
                    <div class="flex items-center">
                        <span class="mr-3 text-sm text-gray-700">Verifikasi:</span>
        ...
        <div class="mt-6">
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    <label for="verify_email" class="font-medium text-gray-700">
